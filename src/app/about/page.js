      ...
      <section className="py-16 sm:py-24 md:py-40 px-4 sm:px-8 md:px-16 bg-white border-b-[8px] sm:border-b-[12px] md:border-b-[20px] border-black overflow-hidden relative">
        ...
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="group relative h-[350px] sm:h-[450px] md:h-[600px] overflow-hidden bg-black border-[3px] sm:border-4 border-black hover:border-primary transition-colors duration-500 flex flex-col justify-between p-6 sm:p-8 md:p-10 cursor-default">
            <img src="/images/strategy.jpeg" alt="Strategy Planning" className="absolute inset-0 w-full h-full object-cover opacity-40 grayscale group-hover:grayscale-0 group-hover:scale-110 group-hover:opacity-60 transition-all duration-700 ease-out" />
          ...
          {/* Production */}
          <div className="group relative h-[350px] sm:h-[450px] md:h-[600px] overflow-hidden bg-black border-[3px] sm:border-4 border-black hover:border-primary transition-colors duration-500 flex flex-col justify-between p-6 sm:p-8 md:p-10 cursor-default">
            <img src="/images/production.jpeg" alt="Cinematic Production" className="absolute inset-0 w-full h-full object-cover opacity-40 grayscale group-hover:grayscale-0 group-hover:scale-110 group-hover:opacity-60 transition-all duration-700 ease-out" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
            <div className="relative z-10 flex justify-between items-start w-full">
          ...
          {/* Execution */}
          <div className="group relative h-[350px] sm:h-[450px] md:h-[600px] overflow-hidden bg-black border-[3px] sm:border-4 border-black hover:border-primary transition-colors duration-500 flex flex-col justify-between p-6 sm:p-8 md:p-10 cursor-default">
            <img src="/images/execution.jpeg" alt="Data and Execution" className="absolute inset-0 w-full h-full object-cover opacity-40 grayscale group-hover:grayscale-0 group-hover:scale-110 group-hover:opacity-60 transition-all duration-700 ease-out" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
            <div className="relative z-10 flex justify-between items-start w-full">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-8 md:gap-12 max-w-7xl mx-auto">
          ...
          <div className="relative group w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-2rem)] max-w-sm mx-auto sm:mx-0">
            <div className="aspect-square bg-white border-[3px] sm:border-4 border-black overflow-hidden relative">
              <img className="w-full h-full object-cover grayscale brightness-110 group-hover:grayscale-0 transition-all duration-300" alt="Nitish Kumar" src="/images/team1.PNG" />
            </div>
          ...
          <div className="relative group w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-2rem)] max-w-sm mx-auto sm:mx-0">
            <div className="aspect-square bg-white border-[3px] sm:border-4 border-black overflow-hidden relative">
              <img className="w-full h-full object-cover grayscale brightness-110 group-hover:grayscale-0 transition-all duration-300" alt="Pintu Kumar" src="/images/team3.PNG" />
            </div>
            <div className="mt-4 md:mt-6 text-center sm:text-left">
